...
package body Mediavision.Images.PNG is

   package Byte_IO is new Ada.Sequential_IO(Element_Type => Mediavision.Images.Image_Byte);
   ...
   procedure Verify_Signature(File : Byte_IO.File_Type) is
      type Signature_Array is array(0 .. 7) of Mediavision.Images.Image_Byte;
   ...
   function Read_Chunk_Size(File : Byte_IO.File_Type) return Natural is
      Raw_Size : array(0 .. 3) of Mediavision.Images.Image_Byte;
   begin
   ...
   procedure Convert_To_Raw(Image : in PNG_Image; Raw_Image : out Mediavision.Images.Image) is
   begin
      raise Mediavision.Not_Implemented;
   end Convert_To_Raw;

   procedure Convert_To_PNG(Raw_Image : in Mediavision.Images.Image; Image : out PNG_Image) is
   begin
      raise Mediavision.Not_Implemented;
   end Convert_To_PNG;
